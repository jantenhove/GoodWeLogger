...
#ifndef SoftwareSerialOld_h
#define SoftwareSerialOld_h
...
class SoftwareSerialOld : public Stream {
public:
	SoftwareSerialOld(int receivePin, int transmitPin, bool inverse_logic = false, int bufSize = 64, int isrBufSize = 0);
	virtual ~SoftwareSerialOld();
